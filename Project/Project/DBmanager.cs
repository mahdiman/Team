...
namespace Project
{
    ...
    class DBManager
    {
        static string DB_Connection_String = @"Data Source=.\SQLEXPRESS;Initial Catalog=TeamDB;Integrated Security=True";
        ...
        // given a query that updates database, this function should exeute it.
        ...
        // performs read queries from a database
